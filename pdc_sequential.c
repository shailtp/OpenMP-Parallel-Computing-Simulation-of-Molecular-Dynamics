...
int main(int argc, char *argv[]) {
    ...
    if (3 < argc) {
        ...
        printf("\n");
        printf(" Enter STEP_NUM, the number of time steps (400, for instance).\n");
        scanf("%d", &step_num);
    }
    ...
    printf("\n");
    printf("MD Sequential\n");
    printf(" C version (No OpenMP)\n");
    printf("\n");
    printf(" A molecular dynamics program.\n");
    printf("\n");
...
// The rest of the functions (compute, dist, initialize, r8_uniform_01, timestamp, update)
// remain the same but with OpenMP directives removed
